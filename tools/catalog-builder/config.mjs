...
export const PROVIDERS = {
  ...
  huggingface: { base: 'https://router.huggingface.co/v1', style: 'openai', autoAdd: true },
  ...
  opencode:    { base: 'https://opencode.ai/zen/v1', style: 'openai', autoAdd: true },
  ...
  zhipu:       { base: 'https://open.bigmodel.cn/api/paas/v4', style: 'openai', autoAdd: true },
