# 自维护目录清单 v2026.09.03.52761

- 生成时间: 2026-09-03T01:40:03.055Z
- 模型总数: 375（按平台分组）
- ✅ = 冒烟实测即时可用（44 个核心模型，auto 路由主要落点）
- 有 key 的平台: cloudflare, google, huggingface, kilo, opencode, openrouter, ovh, zhipu
...
| 模型 | 上下文 | 视觉 | 工具 | 状态 |
|---|---|---|---|---|
| c4ai-aya-expanse-32b | - |  | 启用 |
| c4ai-aya-vision-32b | - |  | 启用 |
| codestral-2508 | 250K |  🔧 | 启用 |
| codestral-latest | 250K |  🔧 | 启用 |
| command-a | 250K |  | 启用 |
| command-a-plus | 250K |  | 启用 |
| command-a-reasoning | 250K |  | 启用 |
| command-a-vision | 250K |  | 启用 |
| command-r | 125K |  🔧 | 启用 |
| command-r-7b | 125K |  | 启用 |
| command-r-plus | 125K |  🔧 | 启用 |
| deepseek-chat | 128K |  🔧 | 启用 |
...
| gpt-4.1-nano | 1023K | 👁 🔧 | 启用 |
| gpt-4o | 125K | 👁 🔧 | 启用 |
| gpt-4o-mini | 125K | 👁 🔧 | 启用 |
| gpt-5 | 391K | 👁 🔧 | 启用 |
| gpt-5-mini | 391K | 👁 🔧 | 启用 |
| gpt-5-nano | 391K | 👁 🔧 | 启用 |
| gpt-5-search-api | 391K | 👁 🔧 | 启用 |
| gpt-5.1 | 391K | 👁 🔧 | 启用 |
| gpt-5.2 | 391K | 👁 🔧 | 启用 |
...
| mistral-medium-3-5 | 256K | 👁 🔧 | 启用 |
| mistral-medium-latest | 125K | 👁 | 启用 |
| mistral-small-2603 | 256K | 👁 🔧 | 启用 |
| mistral-small-latest | 256K | 👁 🔧 | 启用 |
| nemotron-3-super | 977K |  🔧 | 启用 |
| o3 | 195K | 👁 🔧 | 启用 |
| o3-mini | 195K |  🔧 | 启用 |
| o4-mini | 195K | 👁 🔧 | 启用 |
...
| schizogpt | - |  | 启用 |
| sonar | 124K | 👁 | 启用 |
| sonar-deep-research | 125K |  | 启用 |
| sonar-pro | 195K | 👁 | 启用 |
| sonar-reasoning-pro | 125K | 👁 | 启用 |
...
| @cf/meta/llama-3.2-1b-instruct | 128K |  | 启用 |
| @cf/meta/llama-3.2-3b-instruct | 128K |  | 启用 |
| @cf/meta/llama-3.3-70b-instruct-fp8-fast | 23K |  🔧 | 启用 |
...
| gemini-flash-latest-high-res-exp | 1024K |  🔧 | 启用 |
...
| swiss-ai/Apertus-v1.5-8B | 64K |  🔧 | 启用 |
| tencent/Hy3 | 256K |  🔧 | 启用 |
| thinkingmachines/Inkling | 1024K | 👁 🔧 | 启用 |
| zai-org/GLM-4.5 | 128K |  🔧 | 启用 |
...
| 模型 | 上下文 | 视觉 | 工具 | 状态 |
|---|---|---|---|---|
| aphrodite/TheDrummer/Cydonia-24B-v4.3 | 8K |  | 启用 |
...
| Mistral-Small-3.2-24B-Instruct-2506 | 128K |  🔧 | 启用 |
| Qwen2.5-VL-72B-Instruct | 32K | 👁 | 启用 |
| Qwen3-32B | 128K |  🔧 | 启用 |
| Qwen3-Coder-30B-A3B-Instruct | 256K |  🔧 | 启用 |
| Qwen3.5-397B-A17B | 256K |  🔧 | 启用 |
| Qwen3.5-9B | 256K |  🔧 | 启用 |
| Qwen3.6-27B | 128K |  🔧 | 启用 |
| Qwen3.8-27B | 256K |  🔧 | 启用 |
...
| command-a-translate-08-2025 | 250K |  🔧 | 启用 |
| command-a-vision-07-2025 | 125K | 👁 | 启用 |
| command-r-08-2024 | 128K |  🔧 | 启用 |
| command-r-plus-08-2024 | 128K |  🔧 | 启用 |
...
| Qwen/Qwen3-Coder-30B-A3B-Instruct | 256K |  | 启用 |
| Qwen/Qwen3-Next-80B-A3B-Instruct | 256K |  | 启用 |
| Qwen/Qwen3-Next-80B-A3B-Thinking | 256K |  | 启用 |
| Qwen/Qwen3-VL-235B-A22B-Instruct | 128K | 👁 | 启用 |
| Qwen/Qwen3.5-397B-A17B | 256K |  | 启用 |
...
| 模型 | 上下文 | 视觉 | 工具 | 状态 |
|---|---|---|---|---|
| aion-labs/aion-2.0 | 128K |  | 启用 |
| aion-labs/aion-2.5 | 128K |  | 启用 |
| aion-labs/aion-3.0 | 128K |  | 启用 |
...
| mistral-large | 246K |  🔧 | 启用 |
| mistral-medium-3-5 | 250K | 👁 🔧 | 启用 |
...
| 模型 | 上下文 | 视觉 | 工具 | 状态 |
|---|---|---|---|---|
| aisingapore/Gemma-SEA-LION-v4-27B-IT | 128K |  | 启用 |
| aisingapore/Llama-SEA-LION-v3-70B-IT | 128K |  | 启用 |
| aisingapore/Qwen-SEA-LION-v4-32B-IT | 32K |  | 启用 |
...
| 模型 | 上下文 | 视觉 | 工具 | 状态 |
|---|---|---|---|---|
| llama-3.2-3b-instruct:free | 16K |  🔧 | 启用 |
| llama-3.3-70b-instruct:free | 128K |  🔧 | 启用 |
| step-3.7-flash:free | 250K | 👁 🔧 | 启用 |
